...
public class IndexGreaterThan extends Condition {

    private int index;
    private int bound;

    public IndexGreaterThan(GameData gameData, int[] args, int index, int bound) {
        super(gameData, args, ERR_INDEX_TOO_SMALL);
        this.index = index;
        this.bound = bound;
    }
